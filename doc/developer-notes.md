...
Xeon Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Xeon Core, where everyone uses
...
pay attention to for reviewers of Xeon Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Xeon Core uses tinyformat, which is type safe. Leave them out to avoid confusion
