...
Only requiring some minor changes is xeon.cpp.
...
Changes to xeon.cpp
----------------------
xeon.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
