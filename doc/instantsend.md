...
This mechanism has been integrated into Bitcore-Node-Xeon which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/xeonpay/insight-api-xeon#web-socket-api](https://github.com/xeonpay/insight-api-xeon#web-socket-api)
* API: [https://github.com/xeonpay/insight-api-xeon#instantsend-transactions](https://github.com/xeonpay/insight-api-xeon#instantsend-transactions)
...
By default, the Xeon Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Xeon Core daemon:
