...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Xeon related functionality
...
/*
    ...
    allow endless transaction that would bloat Xeon and make it unusable. To
