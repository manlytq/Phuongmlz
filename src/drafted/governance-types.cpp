...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "XeonNetwork") type = XeonNetwork;
    if(strType == "XeonNetworkVariable") type = XeonNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == XeonNetwork) s = "XeonNetwork";
    if(type == XeonNetworkVariable) s = "XeonNetworkVariable";
