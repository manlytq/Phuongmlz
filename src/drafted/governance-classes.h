 ...
 *
 *   // network
 *   CXeonNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.xeon.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CXeonNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: XeonNetwork
// //   -- signature requirements : Key1(User)
// class CXeonNetworkVariable : public CGovernanceObject
// {
// private:
