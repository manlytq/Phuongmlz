    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("XEN-light"), QVariant("light"));
    ui->theme->addItem(QString("XEN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("XEN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("XEN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("XEN-traditional"), QVariant("trad"));
