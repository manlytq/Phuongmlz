    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Xeon Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Xeon Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  xeon-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Xeon in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 XEN, 0.1 XEN, 1 XEN and 10 XEN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://xeonpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://xeonpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Xeon Core is shutting down...") + "<br /><br />" +
