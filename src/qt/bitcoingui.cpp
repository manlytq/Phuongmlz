    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Xeon Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Xeon address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xeon: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Xeon Core"), this);
    aboutAction->setStatusTip(tr("Show information about Xeon Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Xeon Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Xeon addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Xeon addresses"));
    ...
    openAction->setStatusTip(tr("Open a xeon: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Xeon Core help message to get a list with possible Xeon Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Xeon Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Xeon network", "", count));
    } else {
...
{
    QString strTitle = tr("Xeon Core"); // default title
