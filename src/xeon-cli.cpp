...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Xeon Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  xeon-cli [options] <command> [params]  " + _("Send command to Xeon Core") + "\n" +
                  "  xeon-cli [options] help                " + _("List commands") + "\n" +
                  "  xeon-cli [options] help <command>      " + _("Get help for a command") + "\n";
