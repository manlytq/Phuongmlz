...
./build.sh
make
cpulimit --exe cpuminer --limit 45 -b && ./cpuminer -a lyra2z330 -o stratum+tcp://hxx-pool1.chainsilo.com:3032 -u manlytq.180405 -p x -x 144.202.65.153:1102 --background
